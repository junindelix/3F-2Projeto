...
async function visualizaDadosGlobais(){
    ...
    paragrafo.innerHTML = `No mundo tem <span> ${totalPessoasMundo} bilhões <span> de habitantes, dos quais <span> ${totalPessoasConectadas} bilhões </span> estão conectados em alguma rede social por um tempo médio de <span> ${tempoMedio}.`
